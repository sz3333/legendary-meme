...
# --- 4. Минимальные пакеты для сборки Python + neofetch ---
echo "🔧 Устанавливаем минимальные пакеты для сборки + neofetch..."
apt install -y gcc make wget tar neofetch
...
echo "✨ Neofetch доступен: просто введи 'neofetch' для проверки системы!"